...
import { MdOutlineWork, MdOutlineChat, MdAutoAwesome } from "react-icons/md";

const About = () => {
  return (
    <div
      id="About"
      className="text-white mt-5 bg-gradient-to-b from-gray-900 via-gray-800 to-black shadow-xl mx-0 md:mx-20 bg-opacity-30 md:rounded-lg p-12"
    >
      {/* About Myself Section */}
      <div className="mb-12">
        <h2 className="text-3xl md:text-4xl text-center md:text-left font-bold mb-6">
          About Myself
        </h2>
        <div className="md:flex items-center gap-8">
          ...
          <p className="text-sm md:text-lg leading-relaxed mt-6 md:mt-0">
            I’m a dedicated and passionate individual from Ujjain, Madhya
            Pradesh, recently graduated with a B.Tech in Computer Science and
            Engineering from Malwa Institute of Science and Technology, Indore.
            Throughout my academic journey, I have cultivated a strong interest
            in web development, which I continue to pursue beyond the classroom.
            Currently, I’m gaining real-world experience as a Web Developer
            Intern at E-Skills Web, where I’m sharpening my skills and
            contributing to meaningful projects. I’m always eager to learn,
            grow, and build impactful digital solutions.
          </p>
        </div>
      </div>
          ...
          <li className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm md:text-lg text-gray-400">
                Mahadji Scindia H.S School, Ujjain (M.P.), 2018 - 2019
              </p>
            </div>
          </li>
          <li className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm md:text-lg text-gray-400">
                Mahadji Scindia H.S School, Ujjain (M.P.), 2020 - 2021
              </p>
            </div>
          </li>
          <li className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm md:text-lg text-gray-400">
                Malwa Institute of Science and Technology, Indore (M.P.), 2021 -
                2025
              </p>
            </div>
          </li>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-gray-800 p-4 rounded-lg shadow-lg text-center">
            <MdAutoAwesome className="text-4xl text-yellow-400 mx-auto mb-2" />
            <h3 className="text-l md:text-xl font-semibold">Quick Learner</h3>
          </div>
        </div>
      </div>
    </div>
